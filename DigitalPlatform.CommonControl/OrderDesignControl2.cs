...
namespace DigitalPlatform.CommonControl
{
    ...
    public partial class OrderDesignControl2 : UserControl
    {
        ...
        public List<Item2> SelectedItems
        {
            get
            {
                List<Item2> results = new List<Item2>();
        ...
        public void EnableUpdate()
        {
            ...
            if (this.m_nInSuspend == 0)
            {
                ...
                this.dpTable1.EndUpdate();
            }
        }

#if NOOOOOOOOOOOOOOOOOOOOO
        // 根据XML订购记录建立一个新的事项
        public Item2 AppendNewItem(string strDefaultRecord,
            out string strError)
        {
            strError = "";
            ...
            out string strError)
        {
            ...
            Item2 item = AppendNewItem(false);
        ...
        public Item2 AppendNewItem(bool bSetDefaultRecord)
        {
            ...
            try
            {
                ...
                item.AddToTable(this.dpTable1, this.dpTable1.Rows.Count);
        ...
        private void textBox_newlyOrderTotalCopy_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Item2 lastChangeableItem = null; // 遍历中发现的最后一个非“已订购状态”的事项。
        ...
        private void button_newItem_Click(object sender, EventArgs e)
        {
            ...
            this.InsertNewItem(nPos);
        }

        // 最后最靠后的一个未被完全封锁的、可改变copy值的事项
        Item2 GetLastChangeableItem()
        {
        ...
        private void textBox_newlyArriveTotalCopy_TextChanged(object sender, EventArgs e)
        {
            ...
            // TODO: 应先计算出delta值，然后遍历每个item时，一个Item2内添一点(在CopyValue和OldCopyValue之间)
    ...
    public class Item2
    {
        ...
        public OrderDesignControl2 Container = null;
        ...
        public Item2(OrderDesignControl2 container)
        {
            ...
            //// textBox_catalogNo.MinimumSize = new Size(100, 28);
            // textBox_price.Multiline = true;
            textBox_catalogNo.Margin = new Padding(6, 3, 6, 0);
            textBox_catalogNo.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            comboBox_seller.ForeColor = this.Container.dpTable1.ForeColor;
            comboBox_seller.Text = "";

            // 经费来源
            /*
            comboBox_source = new ComboBox();
            comboBox_source.DropDownStyle = ComboBoxStyle.DropDown;
            comboBox_source.FlatStyle = FlatStyle.Flat;
            comboBox_source.DropDownHeight = 300;
            comboBox_source.DropDownWidth = 300;
            //// comboBox_source.Dock = DockStyle.Fill;
            comboBox_source.MaximumSize = new Size(150, 28);
            comboBox_source.Size = new Size(100, 28);
            comboBox_source.MinimumSize = new Size(50, 28);
            comboBox_source.ForeColor = this.Container.tableLayoutPanel_content.ForeColor;
             * */
            ...
            comboBox_source.ComboBox.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            //// comboBox_source.Dock = DockStyle.Fill;
            comboBox_source.MaximumSize = new Size(150, 28 * 2);
            comboBox_source.Size = new Size(100, 28 * 2);
            //// comboBox_source.MinimumSize = new Size(50, 28 * 2);
            ...
            */
            ...
            comboBox_issueCount.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            comboBox_copy.ComboBox.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            //// comboBox_copy.Dock = DockStyle.Fill;
            comboBox_copy.MaximumSize = new Size(100, 28 * 2);
            comboBox_copy.Size = new Size(70, 28 * 2);
            //// comboBox_copy.MinimumSize = new Size(50, 28 * 2);
            ...
            textBox_price.MinimumSize = new Size(100, 28);
            // textBox_price.Multiline = true;
            textBox_price.Margin = new Padding(6, 3, 6, 0);

            textBox_price.ForeColor = this.Container.tableLayoutPanel_content.ForeColor;
             * */
            textBox_price = new DoubleTextBox();
            textBox_price.TextBox.BorderStyle = BorderStyle.None;
            textBox_price.TextBox.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            location.Margin = new Padding(6, 3, 6, 0);

            location.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            comboBox_class.ForeColor = this.Container.dpTable1.ForeColor;
            comboBox_class.Text = "";
            ...
            //// this.label_sellerAddress.MinimumSize = new Size(100, 28);
            // this.label_sellerAddress.Multiline = true;
            this.label_sellerAddress.Margin = new Padding(6, 3, 6, 0);
            this.label_sellerAddress.AutoSize = true;

            this.label_sellerAddress.ForeColor = this.Container.dpTable1.ForeColor;
            ...
            //// this.label_other.MinimumSize = new Size(100, 28);
            // this.label_other.Multiline = true;
            this.label_other.Margin = new Padding(6, 3, 6, 0);
            this.label_other.AutoSize = true;

            this.label_other.ForeColor = this.Container.dpTable1.ForeColor;
        }
        ...
        void AddEvents()
        {
            ...
            this.comboBox_seller.SizeChanged -= new EventHandler(comboBox_seller_SizeChanged);
            this.comboBox_seller.SizeChanged += new EventHandler(comboBox_seller_SizeChanged);
            ...
            this.comboBox_source.SizeChanged -= new EventHandler(comboBox_seller_SizeChanged);
            this.comboBox_source.SizeChanged += new EventHandler(comboBox_seller_SizeChanged);
            ...
            this.comboBox_copy.SizeChanged -= new EventHandler(comboBox_seller_SizeChanged);
            this.comboBox_copy.SizeChanged += new EventHandler(comboBox_seller_SizeChanged);
            ...
            this.comboBox_class.SizeChanged -= new EventHandler(comboBox_seller_SizeChanged);
            this.comboBox_class.SizeChanged += new EventHandler(comboBox_seller_SizeChanged);

        }

        void comboBox_seller_SizeChanged(object sender, EventArgs e)
        {
        ...
        {
            List<Item2> selected_lines = this.Container.SelectedItems;
