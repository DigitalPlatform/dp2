...
namespace DigitalPlatform.LibraryServer
{
    ...
    public partial class LibraryApplication : IDisposable
    {
        ...
        internal static DateTime _expire = new DateTime(2022, 5, 15); // 上一个版本是 2022/3/15 2021/12/15 2021/9/15 2021/7/15 2021/3/15 2020/11/15 2020/7/15 2019/2/15 2019/10/15 2019/7/15 2019/5/15 2019/2/15 2018/11/15 2018/9/15 2018/7/15 2018/5/15 2018/3/15 2017/1/15 2017/12/1 2017/9/1 2017/6/1 2017/3/1 2016/11/1
    ...
    + " 系统仍处于挂起状态。");
        ...
        void OnLibraryXmlChanged(string strAction, string strComment)
        {
            ...
            string new_xml = "";
            if (this._libraryCfgDom != null && this._libraryCfgDom.DocumentElement != null)
                new_xml = this._libraryCfgDom.DocumentElement.OuterXml;
    ...
    strLibraryCodeList);
        ...
        sessioninfo.UserID);
                */
                ...
                if (nRet == -1)
                {
                    strError = "library.xml 修改后自动写入日志时发生错误: " + strError;
                    return -1;
                }
            ...
            out string strError)
        {
            ...
            int changed_count = 0;
            if (CutElement(dom, "accounts"))
                changed_count++;

            if (ClipVirtualDatabases(dom))
                changed_count++;
        ...
        // 剪切掉 virtualDatabases/database 元素的 InnerXml
        static bool ClipVirtualDatabases(XmlDocument dom)
        {
        ...
        static bool CutElement(XmlDocument dom,
            string element_name)
        {
            bool changed = false;
