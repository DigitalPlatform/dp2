...
namespace DigitalPlatform.dp2.Statis
{
    ...
    {
        public event BeforeNavigateEventHandler BeforeNavigate = null;
        ...
        /// </summary>
        /// <param name="nativeActiveXObject">Native ActiveX object</param>
    ...
    public delegate void BeforeNavigateEventHandler(object sender,
        BeforeNavigateArgs e);

    public class BeforeNavigateArgs
    {
        public string url = "";
	    public int flags = 0;
