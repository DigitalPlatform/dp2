    ...
    */
    ...
    JqTreeWidget = (function (_super) {
        ...
        JqTreeWidget.prototype._loadData = function (data, parent_node) {
            ...
            if (!parent_node) {
                ...
                if (selected_nodes_under_parent != null) {  // changed
        ...
        JqTreeWidget.prototype.scrollToNode = function (node) {
            ...
            /*
            console.log("===");
            var obj1 = $element.offset();
            var obj2 = this.$el.offset();
            console.log("obj1=" + obj1);
            console.log("obj2=" + obj2);

            console.log("$element.offset().top=" + $element.offset().top);
            console.log("this.$el.offset().top=" + this.$el.offset().top);
            */
    ...
    SelectNodeHandler = (function () {
        ...
        SelectNodeHandler.prototype.getSelectedNodesUnder = function (parent) {
            var id, node, selected_nodes;
            if (this.selected_single_node) {
                if (parent.isParentOf(this.selected_single_node)) { // changed
                    return this.selected_single_node;
                } else {
                    return null;
                }
