<%@ Page Language="C#" AutoEventWireup="true" Inherits="Preference" 
 MaintainScrollPositionOnPostBack="true" Codebehind="Preference.aspx.cs" %>
...
<head runat="server">
    ...
    <cc1:linkcontrol ID="Linkcontrol2" runat="server" href="preference.css" />
...
<body>
    ...
    <div id="frame">
        ...
        <br />
        <cc1:PreferenceControl ID="PreferenceControl1" runat="server" />
        <br />
