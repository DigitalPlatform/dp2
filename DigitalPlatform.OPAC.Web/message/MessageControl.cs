...
namespace DigitalPlatform.OPAC.Web
{
    ...
    public class MessageControl : WebControl, INamingContainer
    {
        ...
        ResourceManager GetRm()
        {
            ...
            this.m_rm = new ResourceManager("DigitalPlatform.OPAC.Web.res.MessageControl.cs",
