...
namespace DigitalPlatform.GcatClient.gcat_ws {
    using System;
    ...
    public partial class gcat : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public gcat() {
            this.Url = "http://localhost/dp2libraryws/gcat.asmx";
        ...
        /// <remarks/>
        public int EndLogin(System.IAsyncResult asyncResult, out string strError) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetQuestion(System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetQuestion", new object[0], callback, asyncState);
        }
        
        /// <remarks/>
        public int EndGetQuestion(System.IAsyncResult asyncResult, out string strQuestion, out string strError) {
            object[] results = this.EndInvoke(asyncResult);
            strQuestion = ((string)(results[1]));
            strError = ((string)(results[2]));
            return ((int)(results[0]));
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAnswer(string strQuestion, string strAnswer, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("Answer", new object[] {
                        strQuestion,
                        strAnswer}, callback, asyncState);
        }
        
        /// <remarks/>
        public int EndAnswer(System.IAsyncResult asyncResult, out string strError) {
            object[] results = this.EndInvoke(asyncResult);
            strError = ((string)(results[1]));
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetNumber(string strAuthor, bool bSelectPinyin, bool bSelectEntry, bool bOutputDebugInfo, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetNumber", new object[] {
                        strAuthor,
                        bSelectPinyin,
                        bSelectEntry,
                        bOutputDebugInfo}, callback, asyncState);
        }
        
        /// <remarks/>
        public int EndGetNumber(System.IAsyncResult asyncResult, out string strNumber, out string strDebugInfo, out string strError) {
            object[] results = this.EndInvoke(asyncResult);
            strNumber = ((string)(results[1]));
            strDebugInfo = ((string)(results[2]));
            strError = ((string)(results[3]));
