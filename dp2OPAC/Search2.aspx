<%@ Page Language="C#" AutoEventWireup="true" Inherits="Search2" 
 MaintainScrollPositionOnPostBack="true" validateRequest="false" Codebehind="Search2.aspx.cs" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript" src="search2.js"></script>

    <form id="form1" runat="server">
    <div id="frame">
        <cc1:TitleBarControl ID="TitleBarControl1" runat="server" />
        <cc1:SideBarControl ID="SideBarControl1" runat="server" />
        <div id="filter"><p>分析过滤</p>
            <asp:HiddenField ID="resultsetname" runat="server" />
            <div id="progressbar" ></div>
        </div>



        <cc1:ViewResultsetControl ID="ViewResultsetControl1" runat="server" class="fullwidth"/>
